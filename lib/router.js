...
Router.route('/customers', function () {
    ...
    //right
    this.render('customerSubmit', {to: 'rightContainer'});
});
...
Router.route('/products', function () {
    ...
    //right
    this.render('productSubmit', {to: 'rightContainer'});
});
...
//TODO change this to use params

//edit
Router.route('/driversGlobalAdd', {
    name: 'driverGlobalSubmit',
